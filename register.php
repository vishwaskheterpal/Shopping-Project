...
<div class="well well-small">
	...
	<hr class="soft"/>
	<div class="well">
	<form class="form-horizontal" method="post" action = "register_code.php">
		...
		<div class="control-group">
		 ...
		 <div class="control-group">
			...
			<div class="controls">
			  <input type="text" name="phone" placeholder="Mobile Number" id="phone">
			</div>
		 </div>
		<div class="control-group">
	...
	<div class="control-group">
		<div class="controls">
		 <input type="submit" id = "submit" name="submit" value="Register" class="exclusive shopBtn">
		</div>
	</div>
	</form>
</div>
...
<!-- 
PHP backend connection and coding here 
-->
